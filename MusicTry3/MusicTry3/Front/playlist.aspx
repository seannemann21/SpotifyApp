...
<body class="main-color">
    ...
    <div class="container-fluid normal-margins-on-shrink" style="background-color:white;height: 100%;">
        <div class="row" style="padding-left:1em">
          ...
          <div class="col-2 offset-3 hide-on-700-shrink" style="padding-top:0.2em">
            <a href="/session"><button class="btn btn-default">Return</button></a>
          </div>
        </div>
      <!-- Nav tabs -->
    ...
    <div id="bottom-exit" class="show-on-700-shrink" style="position:fixed; bottom:13px;width:100%; display:none;height:24px">
        <a href="/session"><button class="btn btn-default" style="width:100%">Return</button></a>
    </div>
